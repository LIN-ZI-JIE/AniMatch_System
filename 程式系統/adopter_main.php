...
<div class="w3-top">
  <div class="w3-row w3-padding w3-sand">
    ...
    <div class="w3-col s1">
      <a href="javascript:void(0)" class=" w3-padding-large w3-hover-red w3-hide-small w3-right" onclick="document.getElementById('search').style.display='block'" ><i class="fa fa-search"></i></a>
    </div>
    </div>
</div>
