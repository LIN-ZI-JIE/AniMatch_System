...
if(isset($_POST['btn-update']))
{
 ...
 $sql_query = "UPDATE animal_shelter SET member_ID =$member_ID,company_name='$company_name',introduction='$introduction',id_card='$id_card',birthday='$birthday',tel='$tel',email='$email',stray_remark='$stray_remark' WHERE member_ID=$member_ID";
...
<div class="w3-container" id="menu">
  ...
  ?>
        <font size="4">
        <p>中途之家:<input class="w3-input w3-padding-16 w3-border" type="text" placeholder="*中途之家" value="<?php echo $row['company_name']; ?>" required name="company_name"></p>
        <p>簡介：<input class="w3-input w3-padding-16 w3-border" type="text" placeholder="*簡介" value="<?php echo $row['introduction']; ?>"required name="introduction"></p>
        ...
        <p>電子信箱:<input class="w3-input w3-padding-16 w3-border" type="email" placeholder="*電子信箱" value="<?php echo $row['email']; ?>" required name="email"></p>
        <p>備註:<input class="w3-input w3-padding-16 w3-border" type="text" placeholder="備註" value="<?php echo $row['stray_remark']; ?>" name="stray_remark"></p>
        </font>
