...
<div class="w3-top">
  <div class="w3-row w3-padding w3-sand">
    ...
    <div class="w3-col s3">
      <a href="#home" onclick="javascript:location.href='index.php'" class="w3-button w3-block w3-sand">首頁</a>
    </div>
    <div class="w3-col s3">
      <a href="#about" onclick="javascript:location.href='program.php'" class="w3-button w3-block w3-sand">領養程序</a>
    </div>
    <div class="w3-col s3">
      <a href="#animals" onclick="javascript:location.href='map.php'" class="w3-button w3-block w3-sand">寵物醫院</a>
    </div>
    <div class="w3-col s2">
      <a href="#Signin" onclick="document.getElementById('Sign in').style.display='block'" class="w3-button w3-block w3-sand">登入</a>
    </div>    
    </div>
</div>
