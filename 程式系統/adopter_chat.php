...
if(isset($_POST['btn-add']))
{
 ...
 if(mysqli_query($link, $sql))
 {
  ...
  echo "alert('文章發布成功');";
  echo "window.location.href='adopter_chat.php';";
  echo "</script>";
    ...
    <div class="w3-col m7">
	  ...
	  ?>
		...
		<div class="w3-container w3-card w3-white w3-round w3-margin"><br>
		  ...
		  {
		    echo "<a href='adopter_editTitles.php?titles_ID=$titles_ID' style='text-decoration:none;'>
			      <button class='w3-button w3-red' type='submit'>修改</a>
                  <a href='adopter_delTitles.php?titles_ID=$titles_ID' style='text-decoration:none;'>
				  <button class='w3-button w3-black' type='submit'>刪除</button></a>";
		  }
		  ?>
		  
          <button type="submit" class="w3-button w3-theme-d2 w3-margin-bottom w3-right"><i class="fa fa-comment"></i><?php echo "<a href='adopter_message.php?titles_ID=$titles_ID' style='text-decoration:none;'>"; ?>  留言<?php echo "</a>"; ?></button> 
        </div>
      <?php
      }
      ?> 
